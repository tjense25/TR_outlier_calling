...
rule VNTR_outlier_EH:
    ...
    input:
      VNTR_INPUT_EH
    params: 
        str_catalog = "/oak/stanford/groups/smontgom/tannerj/UDN_LRS_watershed/repeat_expansion_testing/1kg.gt.hist.tsv.gz",
    ...
    shell: """
        ...
        awk "\$1==\\"{wildcards.chr}\\"" {input} > {params.tmpdir}/input_VNTR.tsv
